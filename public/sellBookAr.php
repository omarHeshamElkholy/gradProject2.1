        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">بيع لنا كتابك</h2>
                    ...
                    <?php sell_book();   ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="bookSold" class="form-control" placeholder="اسم الكتاب الذي تبيعه" id="email" required data-validation-required-message="Please enter the name of your book.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="Condition" class="form-control" placeholder="حالة الكتاب" id="email" required data-validation-required-message="Please enter the condition of your book.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button name="submit" type="submit" class="btn btn-xl">بيع كتابك</button>
                            </div>
                        </div>
                    </form>
                </div>
